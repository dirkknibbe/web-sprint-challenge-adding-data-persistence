...
1. Explain the difference between Relational Databases and SQL.
   ...
   --- Relational databases are also called SQL databases because SQL is the language relational databases are written in.

2. Why do tables need a Primary Key?

   ---So anyone querying the database can access each row of the table

3. What is the name given to a table column that references the Primary Key on another table?

   ---that would be called a foreign key

4. What do we need in order to have a _many to many_ relationship between two tables?

   ---We need to add a third table which has foreign keys of the two tables it is helping to join.
